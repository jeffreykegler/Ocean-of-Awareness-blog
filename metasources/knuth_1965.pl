...
<html>
  ...
  <body style="max-width:850px">
    ...
    <p>
      ...
      After all,
      it is only four years earlier,
      that stacks were been bleeding edge.
    </p>
    <p>But if the practitioners of 1965,
    are inclined to believe that
    like it or not,
    they are stuck with DPDA-based parsing,
    why do the theoreticians feel compelled to follow them?
    ...
    <h2>The term "language" as of 1965</h2>
        ...
        <p>The problem for Knuth's proof of equivalence is that,
          if you just look at set of strings
          without regard to syntax,
          LR(1) and LR(k) are equivalent.
          That means that from the set-of-strings point of view,
        ...
        <p>
          ...
          If we take visions of that magical world back to the world of practice,
          we cannot assume they will necessarily be relevant for deciding
          what is practical.
        </p>
        <p>
          In fact, we need to be aware that conclusions drawn from the magical
          world of sets of string could be
          be seriously misleading.
          Defining sets of strings as "languages" can makes that magical
          appear more real,
          but that is merely proof that bad definitions can have
